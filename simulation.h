...
{
    public:
        Simulation(int width, int height, int infectTime, int immuneTime, std::unique_ptr<Canvas> canvas, std::unique_ptr<StatisticsHandler> sh);
    ...
    private:
        ...
        void tick();
        void draw_to_canvas();
        int infectTime, immuneTime; // B3 assignment - int values for the amount of ticks for infection & immunity
